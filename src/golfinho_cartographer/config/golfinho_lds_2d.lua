...
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.min_num_points = 200 -- Decrease
...
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.min_num_points = 200 -- Decrease
