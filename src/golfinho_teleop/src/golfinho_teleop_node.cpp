...
#define VEL_ANG_INC 0.08
#define VEL_LIN_INC 0.1
...
class Teleop : public rclcpp::Node{
    public: 
        ...
        Teleop():Node("teleop"){
            ...
            puts("Golfinho Teleop Key | Press arrows ou WASD for move and SPACE to stop");
            puts("Play with Golfinho!");
